...
class _StaggeredScreenState extends State<StaggeredScreen>
  ...
  void initState() {
    ...
    animationWidth = Tween<double>(begin: 20, end: 500).animate(
    ...
    animationRadius = Tween<double>(begin: 0, end: 250).animate(CurvedAnimation(parent: animationController, curve: Interval(
      0.7,
      1.0
    )));

    animationOpacity = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(parent: animationController, curve: Interval(
      0.0,
      1.0
    )));
              ...
              child: Opacity(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: Colors.red,
                      borderRadius: BorderRadius.circular(this.animationRadius.value),
